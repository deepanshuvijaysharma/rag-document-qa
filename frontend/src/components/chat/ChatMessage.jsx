...
import { User, Bot, ChevronDown, ChevronUp, BookOpen, AlertTriangle, Copy, Check } from 'lucide-react';
    ...
    <div className="flex items-start space-x-3 my-5">
      ...
      <div className="max-w-3xl flex-1 bg-slate-900 border border-slate-800 p-5 rounded-2xl rounded-tl-none space-y-5 shadow-lg">
        ...
        {isFallback ? (
          ...
          <div className="prose prose-invert prose-sm max-w-none text-slate-200 leading-relaxed font-sans space-y-3">
            <ReactMarkdown
              components={{
